...
int RS232_OpenComport(int comport_number, int baudrate, const char *mode, int flowctrl)
{
  ...
  switch(baudrate)
  {
    case     110 : strncpy_s(mode_str, 128,"baud=110",128);
                   break;
    case     300 : strncpy_s(mode_str, 128,"baud=300", 128);
                   break;
    case     600 : strncpy_s(mode_str, 128,"baud=600",128);
                   break;
    case    1200 : strncpy_s(mode_str, 128,"baud=1200",128);
                   break;
    case    2400 : strncpy_s(mode_str, 128,"baud=2400",128);
                   break;
    case    4800 : strncpy_s(mode_str, 128,"baud=4800",128);
                   break;
    case    9600 : strncpy_s(mode_str, 128,"baud=9600",128);
                   break;
    case   19200 : strncpy_s(mode_str, 128,"baud=19200",128);
                   break;
    case   38400 : strncpy_s(mode_str, 128,"baud=38400",128);
                   break;
    case   57600 : strncpy_s(mode_str, 128,"baud=57600",128);
                   break;
    case  115200 : strncpy_s(mode_str, 128,"baud=115200",128);
                   break;
    case  128000 : strncpy_s(mode_str, 128,"baud=128000",128);
                   break;
    case  256000 : strncpy_s(mode_str, 128,"baud=256000",128);
                   break;
    case  500000 : strncpy_s(mode_str, 128,"baud=500000",128);
                   break;
    case  921600 : strncpy_s(mode_str, 128,"baud=921600",128);
                   break;
    case 1000000 : strncpy_s(mode_str, 128,"baud=1000000",128);
                   break;
    case 1500000 : strncpy_s(mode_str, 128,"baud=1500000",128);
                   break;
    case 2000000 : strncpy_s(mode_str, 128,"baud=2000000",128);
                   break;
    case 3000000 : strncpy_s(mode_str, 128,"baud=3000000",128);
                   break;
    default      : printf("invalid baudrate\n");
                   return(1);
                   break;
  ...
  switch(mode[0])
  {
    case '8': strncat_s(mode_str,128, " data=8",128);
              break;
    case '7': strncat_s(mode_str, 128, " data=7", 128);
              break;
    case '6': strncat_s(mode_str, 128, " data=6", 128);
              break;
    case '5': strncat_s(mode_str, 128, " data=5", 128);
              break;
    default : printf("invalid number of data-bits '%c'\n", mode[0]);
              return(1);
              break;
  ...
  {
    case 'N':
    case 'n': strncat_s(mode_str, 128," parity=n",128);
              break;
    case 'E':
    case 'e': strncat_s(mode_str, 128," parity=e", 128);
              break;
    case 'O':
    case 'o': strncat_s(mode_str, 128," parity=o", 128);
              break;
    default : printf("invalid parity '%c'\n", mode[1]);
              return(1);
              break;
  ...
  switch(mode[2])
  {
    case '1': strncat_s(mode_str, 128," stop=1", 128);
              break;
    case '2': strncat_s(mode_str, 128," stop=2", 128);
              break;
    default : printf("invalid number of stop bits '%c'\n", mode[2]);
              return(1);
              break;
  ...
  if(flowctrl)
  {
    strncat_s(mode_str, 128," xon=off to=off odsr=off dtr=on rts=off", 128);
  }
  else
  {
    strncat_s(mode_str, 128," xon=off to=off odsr=off dtr=on rts=on", 128);
  }
...
int RS232_PollComportLine(int comport_number, unsigned char* buf, int size)
{
	...
	{
		int nRead;
		ReadFile(Cport[comport_number], buf+n, 1, (LPDWORD)((void*)& nRead), NULL);
		n += nRead;
		if (n >= size)
			return n;
	} while (buf[n-1] != '\n');
