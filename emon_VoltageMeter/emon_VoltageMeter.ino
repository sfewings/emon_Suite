...
void loop()
{
  wdt_reset();
	...
	g_payloadBattery.voltage[0] = (short) Reading(0, 0, 0, 0.1875 * (10000 + 510) / 510 / 10, noisyData );
	g_payloadBattery.voltage[1] = (short) Reading(1, 0, 1, 0.1875 * (10000 + 510) / 510 / 10, noisyData );
	g_payloadBattery.voltage[2] = (short) Reading(2, 0, 2, 0.1875 * (10000 + 510) / 510 / 10, noisyData );
	g_payloadBattery.voltage[3] = (short) Reading(3, 0, 3, 0.1875 * (10000 + 510) / 510 / 10, noisyData );
  	wdt_reset();
