...
# docker buildx build --platform linux/arm64 -f emon_settings_web/Dockerfile -t "sfewings32/emon_settings_web:latest" --push . 
...
# docker buildx build --platform linux/arm64 -f GPSDToMQTT.Dockerfile -t "sfewings32/emon_gpsd_to_mqtt:latest" --push .
docker buildx build --platform linux/arm/v7 -f emon_settings_web/Dockerfile -t "sfewings32/emon_settings_web:latest" . 
docker buildx build --platform linux/arm/v7 -f serialToMQTT.Dockerfile -t "sfewings32/emon_serial_to_mqtt:latest"  . 
docker buildx build --platform linux/arm/v7 -f MQTTToInflux.Dockerfile -t "sfewings32/emon_mqtt_to_influx:latest"  .
docker buildx build --platform linux/arm/v7 -f MQTTToLog.Dockerfile -t "sfewings32/emon_mqtt_to_log:latest"  .
#docker buildx build --platform linux/arm/v7 -f GPSDToMQTT.Dockerfile -t "sfewings32/emon_gpsd_to_mqtt:latest"  .
