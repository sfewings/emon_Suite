...
**`YWA SRRC VERSION Sept19`**, the Yachting WA / Department of Transport navaid
register (supplied as a legacy `.xls`, single sheet). This is the single source of
truth for mark positions. It carries, per mark: WGS84 decimal degrees to six
places, MGA94 easting/northing, owning club, rounding direction, structure and top
mark colour, and light characteristics.

`config/marks.json` and `config/lines.json` are generated from it. All twenty
marks used by the 2026-27 PFSYC course sheets resolve cleanly, including Mosman A
(14), which was absent from every other source consulted.
...
| End                   | lat        | lon        | source             |
| --------------------- | ---------- | ---------- | ------------------ |
| Inner (start box)     | -32.001948 | 115.812006 | user-supplied-2026 |
| Outer (Club Buoy 32A) | -32.002750 | 115.812812 | ywa-srrc-2019      |

**Length 117.3 m (0.063 nm), orientation 139.6 / 319.6 degrees true.**

An earlier version of this document gave 259.8 m on 110.1 / 290.1, derived from
