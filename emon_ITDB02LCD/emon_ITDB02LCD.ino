...
//ITDB02 myGLCD(A1,A2,A0,A4,A5, ITDB32S);   //
...
/*     Serial.print("MAC: ");
  ...
  */ 
   ...
   rf12_initialize(MYNODE, freq,group,10);
...
*/
    ...
    if ((millis()-fast_update)>200)
    {
      ...
      print_emontx_payload();

      //myGLCD.printNumI(emontx.power,30, 20);
      //myGLCD.printNumI(emontx.ct1,100, 20);
      //myGLCD.printNumI(emontx.supplyV,180, 20);
